...
* [Thymeleaf](https://docs.spring.io/spring-boot/3.4.2-SNAPSHOT/reference/web/servlet.html#web.servlet.spring-mvc.template-engines)
* [Spring Boot DevTools](https://docs.spring.io/spring-boot/3.4.2-SNAPSHOT/reference/using/devtools.html)
* [OAuth2 Client](https://docs.spring.io/spring-boot/3.4.2-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.client)
